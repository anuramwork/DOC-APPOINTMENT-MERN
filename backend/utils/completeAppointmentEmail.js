export const generateAppointmentCompletedEmailHTML = (appointmentData) => `
    ...
    <table style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
      ...
      <tr>
        <td style="background-color: #198754; padding: 20px; color: #ffffff; text-align: center;">
          <h1 style="margin: 0; font-size: 24px;">Appointment Completed</h1>
        </td>
      </tr>
      ...
      <tr>
        <td style="padding: 30px;">
          <p style="font-size: 16px; margin-bottom: 20px;">
            Dear <strong>${appointmentData.userData.name}</strong>,
          </p>

          <p style="font-size: 16px; margin-bottom: 20px;">
            We’re writing to let you know that your appointment has been successfully <strong>completed</strong>. Here are the details:
          </p>

          <table style="width: 100%; font-size: 15px; border-collapse: collapse;">
            <tr>
              <td style="padding: 8px 0;"><strong>Doctor</strong></td>
              <td style="padding: 8px 0;">Dr. ${appointmentData.docData.name}</td>
            </tr>
            <tr>
          ...
          <div style="margin-top: 30px;">
            <p style="font-size: 15px;">
              Thank you for choosing our clinic. We hope your experience was satisfactory. If you have any feedback or questions, please don’t hesitate to reach out.
            </p>

            <p style="margin-top: 20px;">Wishing you good health,</p>
